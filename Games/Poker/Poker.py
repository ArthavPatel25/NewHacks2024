...
try:
    table_img = pygame.image.load("Images/poker_table.jpg")
...
class PokerGame:
    def __init__(self):
        self.players = [
            Player("Player 1", 1000, (50, HEIGHT - 150), "Images\player1_avatar.png"),
            Player("Player 2", 1000, (WIDTH - 200, HEIGHT - 150), "Images\player2_avatar.png", is_ai=True),
        ]
        self.host = Player("Host", float('inf'), (WIDTH // 2 - 30, HEIGHT // 2 - 100), "Images\host_avatar.png")
...
def draw_points(screen, players):
    ...
    screen.blit(player1_text, (50, 25))
    screen.blit(player2_text, (WIDTH - player2_text.get_width() - 50, 25))
